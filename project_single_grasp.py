...
class RoboHandler:
    ...
    def openrave_init(self):
        ...
        self.right_manip = self.robot.GetManipulator('rightarm')
    ...
    def check_collision(self, grasp_left, grasp_right):
        with openravepy.RobotStateSaver(self.gmodel.robot):
            with openravepy.RobotStateSaver(self.gmodel_right.robot):
                with self.env:
                    contacts_left, finalconfig_left, mindist_left, volume_left = self.gmodel.testGrasp(
                    ...
                    self.gmodel.robot.SetDOFValues(finalconfig_left[0])
                    self.gmodel.robot.SetTransform(finalconfig_left[1])
                    ...
                    return self.env.CheckCollision(self.robot, self.robot)
    ...
    def order_grasps(self):
        ...
        self.grasps_filtered = self.grasps
